...
import { ArrowLeftIcon, Briefcase, ChevronLeft, FileText, FolderIcon, GraduationCap, Sparkles, User, ChevronRight, Share2Icon, EyeIcon, EyeOffIcon, DownloadIcon } from 'lucide-react'
    ...
    <div>
      ...
      <div className='max-w-7xl mx-auto px-4 pb-8'>
        <div className='grid lg:grid-cols-12 gap-8'>
          {/* Left Panel - Form */}
          <div className='relative lg:col-span-5 rounded-lg oerflow-hidden'>
              ...
              <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'>
                ...
                <div className='flex items-center'>
                  {activeSectionIndex !== 0 && (
                    ...
                    max(prevIndex - 1, 0))}className='flex items-center gap-1 p-3 rounded-lg text-sm font-medium
                    text-gray-600 hover:bg-gray-50 transition-all' disabled={activeSectionIndex===0}>
                      <ChevronLeft className='size-4'/> Previous
                    </button>
                  ) }
                  <button onClick={()=> setActiveSectionIndex((prevIndex)=> Math.
                    min(prevIndex + 1, sections.length - 1))} className={`flex items-center gap-1 p-3 rounded-lg text-sm font-medium 
                ...
                <div className='relative w-full'>
                  <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'> 
                    ...
                    <button onClick={changeResumeVisibility} className='flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br
                     from-purple-100 to-purple-300 text-purple-600 ring-purple-300 
                     rounded-lg hover:ring transition-colors'>
                    ...
                    bg-gradient-to-br from-green-100 to-green-300 text-green-600 rounded-lg
