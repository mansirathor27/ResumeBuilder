...
const Features = () => {
  ...
  return (
    ...
    <Title title='Build your resume' description='Our streamlined process helps you create a professional resume in minutes wuth intelligent AI-powered tools and features.'/>
